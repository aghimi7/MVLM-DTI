...
readme_text = f"""# MVLM-DTI: Multi-View Linear Manifold for Drug-Target Interaction
...
# Write the text to the README.md file (this overwrites the old one)
with open("README.md", "w", encoding="utf-8") as f:
    f.write(readme_text)

print("SUCCESS: README.md has been generated perfectly without emojis or icons!")
